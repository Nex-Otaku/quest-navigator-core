...
(function( $ ){
	$.fn.retina = function(retina_part) {
		...
		this.each(function(index, element) {
			...
			// Ќастраиваем стили DIV и IMG, чтобы DIV был точно по размеру IMG
...
(function( $ ){
	$.fn.updateSrcRetina = function(path) {
		// ќбновл€ем картинку внешнего блока, дл€ поддержки Retina-дисплеев
		if (qspScreenHD)
		{
			var p = this.parent();
